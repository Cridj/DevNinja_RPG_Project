...
namespace Assets.HeroEditor.Common.CharacterScripts
{
    ...
    public partial class Character : CharacterBase
    {
        ...
        private void Awake()
        {
            ...
            {
                transform.GetComponent<Hero>().renderers.Add(renderer);
            }
            foreach (var renderer in BodyRenderers)
            {
                transform.GetComponent<Hero>().renderers.Add(renderer);
            }
            transform.GetComponent<Hero>().renderers.Add(HeadRenderer);
            transform.GetComponent<Hero>().renderers.Add(EarsRenderer);
            transform.GetComponent<Hero>().renderers.Add(HairRenderer);
            transform.GetComponent<Hero>().renderers.Add(EyebrowsRenderer);
            transform.GetComponent<Hero>().renderers.Add(EyesRenderer);
            transform.GetComponent<Hero>().renderers.Add(MouthRenderer);
            transform.GetComponent<Hero>().renderers.Add(BeardRenderer);

            transform.GetComponent<Hero>().renderers.Add(HelmetRenderer);
            transform.GetComponent<Hero>().renderers.Add(GlassesRenderer);
            transform.GetComponent<Hero>().renderers.Add(MaskRenderer);
            transform.GetComponent<Hero>().renderers.Add(EarringsRenderer);
            transform.GetComponent<Hero>().renderers.Add(PrimaryMeleeWeaponRenderer);
            transform.GetComponent<Hero>().renderers.Add(SecondaryMeleeWeaponRenderer);
        }
